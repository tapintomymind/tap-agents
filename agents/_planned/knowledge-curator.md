...
activation_trigger: |
  ...
  (1) First project crosses a phase-transition cadence boundary with >=5 Decision Packets
      accumulated (today: tapagents-app, formerly agent-dashboard pre-2026-05-14 BL-059, is
      approaching this with ~6 packets in workspace/tapagents-app/).
...
1. **First project crosses a phase-transition cadence boundary with >=5 Decision Packets
   accumulated.** Today: `tapagents-app` (formerly agent-dashboard pre-2026-05-14 BL-059) is approaching this with ~6 packets already.
