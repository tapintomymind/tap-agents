...
**Additive promotion.** The original planned stub is retained in place at `agents/_planned/release-coordinator.md` with a PROMOTED marker and a `promoted_to` pointer to the live contract — the consumer-visible surface gains an agent; nothing is removed. **Additive — adopters at v0.36.0 continue unchanged.**
